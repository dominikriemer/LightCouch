...
public class CouchDbProperties {
    ...
    public CouchDbProperties(String dbName, boolean createDbIfNotExist, String protocol, String host, int port,
    ...
    public CouchDbProperties setConnectionTTL(int connectionTTL) {
